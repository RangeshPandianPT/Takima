...
const appCss = "/assets/styles-C-Ghda_q.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "TAKIMA — The House of Creams" },
...
const $$splitComponentImporter = () => import("./index-CLAWE3w6.mjs");
const TITLE = "TAKIMA — The House of Creams | Artisanal Café in Cumbum";
const DESCRIPTION = "Cumbum's first artisanal café & creamery. Handcrafted ice creams, waffles, sundaes, premium coffee & signature desserts, served in a luxe, family-friendly space.";
